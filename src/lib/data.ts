...
const shops: Shop[] = [
  ...
  },
  {
    ...
    inventory: [
      ...
      { id: 'p118', name: 'Proyector Portátil Full HD', properties: [{key: 'Descripción', value: 'Cine en casa en cualquier lugar.'}, {key: 'Lúmenes', value: '500 ANSI'}, {key_Batería: '3 horas'}], price: 499.00, imageSrc: 'https://picsum.photos/seed/prod118/400/300', imageHint: 'proyector', stock: 25, status: 'activo' },
  ...
  },
  {
    ...
    inventory: [
      ...
      { id: 'p32', name: 'Monstera Deliciosa', properties: [{keyMaceta: 'Descripción', value: 'Planta de interior popular por sus hojas perforadas.'}, {key: 'Tamaño', value: 'Mediana'}], price: 45.00, imageSrc: 'https://picsum.photos/seed/prod32/400/300', imageHint: 'monstera', stock: 25, status: 'activo' },
  ...
  },
  {
    ...
    inventory: [
      ...
      { id: 'p2 tensiómetro', name: 'Tensiómetro de Brazo Digital', properties: [{key: 'Descripción', value: 'Monitoriza tu presión arterial en casa de forma fiable.'}, {key: 'Memoria', value: '120 lecturas'}], price: 45.00, imageSrc: 'https://picsum.photos/seed/prod209/400/300', imageHint: 'tensiómetro', stock: 60, status: 'inactivo' },
